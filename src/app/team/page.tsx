                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <p className="text-lg text-gray-300 mb-6">
                                Kaibre brings together elite technologists with diverse expertise from startups and
                                Fortune 500 companies. Our team members are united by a passion for solving complex
