...
const GridItem = ({ area, icon, title, description, href }: GridItemProps) => {
  return (
    <li className={`min-h-[10rem] md:min-h-[14rem] list-none mx-2 md:mx-0 ${area}`}>
      <Link href={href}>
  ...
  return (
    <section className="py-10">
      <div className="text-center mb-12">
        <h2 className="text-2xl md:text-4xl font-bold mb-2 font-panchang">
          OUR SERVICES
        </h2>
        <p className="text-xl text-foreground max-w-2xl mx-auto font-supreme px-2">
          From custom software to embedded talent, we deliver the full spectrum
          of modern technology solutions.
        </p>
      </div>
      <ul className="grid grid-cols-1 grid-rows-none gap-3 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2 max-w-6xl mx-auto md:px-2">
