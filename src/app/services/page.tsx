...
import MobileServiceSelector from "@/components/mobile-service-selector";
...
function ServicesContent() {
    ...
    () => [
      {
        ...
        description:
          "Tailored solutions for your unique business needs, from web apps to automation.",
      },
      {
        id: "ai",
        title: "AI & Data",
        description:
          "Unlock insights and automation with advanced data engineering and AI/ML solutions.",
      },
      {
        id: "team",
        title: "Team Augmentation",
        description:
          "Embed elite engineers into your teams to accelerate delivery and scale.",
      },
      {
        id: "security",
        title: "Security & Compliance",
        description:
          "Protect your business with best-in-class security practices and compliance support.",
      },
      {
        id: "cloud",
        title: "Cloud & DevOps",
        description:
          "Modern infrastructure, CI/CD, and cloud-native deployments for reliability and speed.",
      },
    ],
    []
  );
  ...
  const initialId =
    sectionParam && componentsById[sectionParam] ? sectionParam : defaultId;
  ...
  const handleCategorySelect = (id: string, mobile: boolean) => {

    mobile && document.querySelector('#service-list-section')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
  ...
  return (
    <main className="min-h-screen">
      <HeroSection
        ...
        subtitle="Whether you need flawless software, strategic guidance, or want to build a high-performance tech team, we're your technology force multiplier."
      />
      ...
      <section className="flex flex-col scroll-mt-40" id="service-list-section">
        <div
          className="md:flex gap-6 pb-20 max-w-7xl mx-auto justify-center"
          id="list"
          aria-live="polite"
        >
          {/* Left Sidebar - Service Categories */}

          <ServiceCategories categories={categories} selectedId={selectedId} onCategorySelect={handleCategorySelect} />
            ...
            {SelectedComponent ? (
              ...
              <div className=" text-center min-h-[600px] flex items-center justify-center">
                <div className="max-w-md mx-auto">
                  <h3 className="text-xl font-semibold text-white mb-2 font-panchang">
...
const ServiceCategories = ({ categories, selectedId, onCategorySelect }: ServiceCategoriesProps) => {
  return (
      ...
      <div className="p-4 space-y-2">
        {categories.map((category) => (
          <button
            key={category.id}
            type="button"
            onClick={() => onCategorySelect(category.id, false)}
          ...
          >
            <div className="flex-1">
              <div className="font-medium text-sm font-panchang">
                {category.title}
              </div>
              <div className="text-sm opacity-75 mt-1 font-supreme">
