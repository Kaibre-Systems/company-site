...
export const ID: IndoContent = {
  ...
  hero: {
    ...
    panel: {
      alt: "Halaman temuan ilustratif dari asesmen kepatuhan SecurePulse untuk bank Indonesia fiktif: temuan berkeparahan tinggi bahwa tinjauan akses diklaim namun tidak terbukti, beserta ketentuan, hasil observasi, remediasi, dan status penelaah.",
      tag: "Ilustratif",
      ...
      finding: {
        id: "F-01",
        severity: "Tinggi",
        title: "Tinjauan akses diklaim, namun tidak terbukti untuk diandalkan",
        meta: "Manajemen akses · 8 poin",
      },
      rows: [
        { label: "Ketentuan", value: "Akses ke data nasabah dibatasi sesuai peran yang berwenang" },
        {
          label: "Observasi",
          value: "Kebijakan menetapkan akses berbasis peran — catatan tinjauan berkala tidak lengkap",
          secondary: true,
        },
        { label: "Remediasi", value: "Pulihkan siklus tinjauan; simpan catatan pengesahan — segera" },
