...
export const ID: IndoContent = {
  ...
  hero: {
    ...
    panel: {
      alt: "Halaman temuan terperinci ilustratif dari asesmen kepatuhan SecurePulse untuk bank Indonesia fiktif: temuan berkeparahan tinggi bahwa resertifikasi akses istimewa meninggalkan tiga akun tanpa atestasi, beserta hasil observasi, risikonya, remediasi segera, dan status penelaah.",
      tag: "Ilustratif",
      institution: "PT Bank Selat Biru",
      title: "Asesmen kepatuhan regulasi",
      docMeta: "Draf 1.0 · Untuk telaah manajemen",
      finding: {
        id: "F-01",
        severity: "Tinggi",
        title: "Resertifikasi akses istimewa diklaim, namun tiga akun tanpa atestasi",
        meta: "Tata kelola akses · 8 poin",
      },
      body: [
        {
          label: "Yang kami amati",
          text: "Ekspor hak akses IAM mencatat 14 akun istimewa pada sistem data nasabah produksi; atestasi resertifikasi TW2 hanya mencakup 11. Dua akun layanan bersama dan satu akun administrator dorman tanpa atestasi, dan catatan deaktivasi tidak tersedia.",
        },
        {
          label: "Risiko",
          text: "Akses istimewa tanpa atestasi ke data nasabah tidak dapat menopang keandalan manajemen maupun respons pemeriksaan.",
          secondary: true,
        },
        {
          label: "Remediasi",
          text: "Segera — resertifikasi atau bekukan ketiga akun; simpan atestasi dan catatan deaktivasinya.",
        },
        {
          label: "Penelaah",
      ...
      pageLine: "Temuan terperinci · 5 / 12",
    },
  },
  inOut: {
  ...
  deliverables: {
    ...
    roadmap: {
      ...
      columns: {
        ...
        reduction: "Penurunan risiko",
      },
      rows: [
        {
          phase: "Segera (0‑30 hr)",
          action: "Resertifikasi atau bekukan akun istimewa tanpa atestasi; simpan atestasinya",
          owner: "Manajer keamanan",
          reduction: "Tinggi",
        },
        {
          phase: "Jangka pendek (1‑6 bln)",
          action: "Validasi bukti secara sampel atas pengendalian akses dan perubahan",
          owner: "Penelaah utama",
          reduction: "Tinggi",
        },
        {
          phase: "Jangka panjang (6‑12 bln+)",
          action: "Asesmen tahunan berbasis bukti dengan penyimpanan artefak yang wajib",
          owner: "Tata kelola",
          reduction: "Sedang",
        },
      ],
