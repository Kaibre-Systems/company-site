...
export const EN: IndoContent = {
  ...
  hero: {
    ...
    panel: {
      alt: "Illustrative finding page from a SecurePulse compliance assessment for a fictional Indonesian bank: a high-severity finding that access reviews are asserted but not evidenced, with the requirement, what was observed, the remediation, and the reviewer state.",
      tag: "Illustrative",
      ...
      finding: {
        id: "F-01",
        severity: "High",
        title: "Access reviews asserted, but not evidenced for reliance",
        meta: "Access management · 8 points",
      },
      rows: [
        { label: "Requirement", value: "Access to customer data restricted to authorised roles" },
        {
          label: "Observed",
          value: "Policy defines role-based access — periodic review records are incomplete",
          secondary: true,
        },
        { label: "Remediation", value: "Reinstate the review cycle; retain sign-off records — immediate" },
